...
async def on_message(message):
    ...
    if "정이라고하자" in msg or "정이라고 하자" in msg:
        ...
        "씨발" in msg or "병신" in msg or "시발" in msg
    ) and message.author.name == "zghik5":
        ...
        print(os.system("cd .. && cd palworld-server-docker && docker-compose start"))

    elif "팔월드 서버 종료" == msg:
        msg = "서버를 종료합니다."
        await message.channel.send(msg)
        print(os.system("cd .. && cd palworld-server-docker"))
        print(os.system("pwd"))
        print(os.system("docker-compose stop"))
        ...
        print(os.system("cd .. && cd palworld-server-docker"))
        print(os.system("pwd"))
        print(os.system("docker-compose restart"))
...
async def on_message_edit(before, after):
    if before.author.name == "zghik5":
        embed = discord.Embed(
            title=before.content + " ->", description=after.content, color=0x00AAAA
        )
